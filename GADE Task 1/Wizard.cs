...
namespace GADE_Task_1
{
    class Wizard : Unit
    {
        public Wizard(int x, int y, int health, int speed, int attack, int attackRange, int team, string symbol)
        {
            this.x = x;
            this.y = y;
            this.health = health;
        ...
        public override int Team
        {
            ...
            set
            {
                Team = 10;// wizards will be team 10
            }
        }
        ...
        public override void Move(ref Unit closestUnit)
        {
            ...
            {
                //combat
                if (health < 50)   //if the health is below 50hp then they must run away
                {
